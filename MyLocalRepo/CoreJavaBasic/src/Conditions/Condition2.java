...
public class Condition2 {
	...
	public static void main(String[] args) {
		//defining a variable  
				...
				Condition2.checkEvenOddNumber(700);
			...
			static void checkEvenOddNumber(int num) {//int num=700;
				if(num%2==0){  
					System.out.println("Given number is even number: "+num);  //even 700
				}else{  
					System.out.println("Given number is odd number: "+num);  //odd
				}
			}
			/**
			...
			static void checkEvenOddNumber2() {
				int num=50;
				if(num%2==0){  
					System.out.println("Given number is even number: "+num);//  even
				}else{  
